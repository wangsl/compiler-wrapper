...
function main() 
{
    ...
    export OPTIMIZATION_FLAGS_FOR_INTEL_COMPILERS="-O3 -fPIC -unroll -ip -axSSE3 -xSSE3 -openmp -vec-report -par-report -openmp-report -Wno-deprecated"
    export OPTIMIZATION_FLAGS_FOR_INTEL_FORTRAN_COMPILERS="-O3 -fPIC -unroll -ip -axSSE3 -xSSE3 -openmp -vec-report -par-report -openmp-report"
